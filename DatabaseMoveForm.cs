...
namespace WTF
{
    ...
    public sealed class DatabaseMoveForm : Form
    {
        ...
        public DatabaseMoveForm(AppLayout layout, string currentDatabasePath)
        {
            ...
            LucidLabel labelCurrentPath = new LucidLabel
            {
            ...
            LucidTextBox textBoxCurrentDatabasePath = new LucidTextBox
            {
            ...
            LucidLabel labelHint = new LucidLabel
            {
            ...
            LucidButton buttonMoveCurrentDatabase = new LucidButton
            {
            ...
            LucidButton buttonUseExistingDatabase = new LucidButton
            {
            ...
            LucidButton buttonCreateNewDatabase = new LucidButton
            {
            ...
            LucidButton buttonCancel = new LucidButton
            {
