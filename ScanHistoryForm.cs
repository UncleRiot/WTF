...
namespace WTF
{
    public sealed class ScanHistoryForm : Form
    {
        ...
        private LucidLabel labelBaselineScan;
        private LucidLabel labelCompareScan;
        private ComboBox comboBoxBaselineScan;
        private ComboBox comboBoxCompareScan;
        private LucidButton buttonCompare;
        private LucidButton buttonClose;
        private LucidButton buttonRefresh;
        private LucidLabel labelStatus;
        ...
        private void InitializeComponent()
        {
            ...
            labelBaselineScan = new LucidLabel
            {
            ...
            labelCompareScan = new LucidLabel
            {
        ...
        private static DataGridView CreateGrid(string name)
        {
            DataGridView grid = new DataGridView
            {
                ...
                BackgroundColor = ThemeProvider.Theme.Colors.BackgroundSecondary,
        ...
        private sealed class ScanHistoryTabControl : TabControl
        {
            ...
            protected override void OnDrawItem(DrawItemEventArgs e)
            {
                ...
                Color accentColor = ThemeProvider.Theme.Colors.Accent;
